...
from training.validation_text import validate
...
def train_text_encoder(
    ...
    for epoch in range(start_epoch + 1, epochs):
        ...
        for idx, (safe_caption, nsfw_caption, harmless_caption) in enumerate(tqdm(train_loader)):
            ...
            # training_loss = lambdas[0] * loss_safe + lambdas[1] * loss_nsfw + lambdas[2] * loss_harmless
