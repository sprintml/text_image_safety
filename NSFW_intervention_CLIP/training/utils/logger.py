...
def summarize(epoch, patience, training_loss, this_validation_loss, val_loss_safe, val_loss_nsfw, val_loss_harmless, this_recalls, best_recall_sum, best_validation_loss, training_time, validation_time, best_checkpoint_saving_path):
    epoch_summary = f'''
*************** Epoch {epoch} ***************
patience: {patience}
############### Training Loss ###############
...
val_loss_safe: {val_loss_safe}
val_loss_nsfw: {val_loss_nsfw}
val_loss_harmless: {val_loss_harmless}
###############################################
