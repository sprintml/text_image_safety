...
def compute_clip_scores(
        clip_model, image_path, original_image_path, device, batch_size, prompts
): 
    
    # create list of images with path
    images = [f"{image_path}/{i}.png" for i in range(100)]
    print(images)
    original_images = [f"{original_image_path}/{i}.png" for i in range(100)]
    print(original_images)
    

    return clip_metrics(clip_model, images, original_images, device, batch_size, prompts, None, None, None, None)
