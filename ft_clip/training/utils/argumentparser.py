...
def parse_arguments():
    ...
    parser.add_argument("--epoches", type=int, help="Epoches number", default=20)
    parser.add_argument("--lr", type=float, help="Learning rate value", default=1e-5)
    ...
    # NOTE : modification to the lambdas
    parser.add_argument("-l", "--lambdas", type=str, help="Lambda weights values in a tuple", default='(1,1,1)')
    # parser.add_argument("-l", "--lambdas", type=int, help="Lambda weights values in a tuple", default=1)
    ...
    parser.add_argument("--gradient-accumulation-steps", type=int, help="Number of gradient accumulation steps", default=5)
    ...
    parser.add_argument("--train-type", help="Debug mode", default="all")
