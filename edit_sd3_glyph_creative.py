...
# Full toxic bench
# prompts_A, prompts_B = prepare_full_toxic_bench_with_args(
#     toxic_path="./src/data/train/toxic_words.txt",
#     non_toxic_path="./src/data/train/toxic_mappings.txt",
...
original_images_A, original_last_images_A = sample(
...
original_images_A_feats = extract_all_images(
    original_last_images_A, clip_model, DEVICE, batch_size=BATCH_SIZE
)

logging.info("Sampling original images B ...")
original_images_B, original_last_images_B = sample(
